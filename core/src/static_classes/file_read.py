...
class FileFilter(object):
    ...
    @staticmethod
    def file_deal(paths, info_list: BasicInfoList, clear_list: bool = False, pattern=r'^[.\n]*$',
                  is_file=True,
                  replace_str: str = '', names: dict = None, type_set=1, *more_replace):
        data = GlobalData()

        def info_write_builder(is_files, dict_path_group, replace_string, info_group,
                               names_dict, type_use, more_replace_str):
