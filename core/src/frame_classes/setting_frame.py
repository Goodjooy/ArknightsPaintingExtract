...
from core.src.structs_classes.painting_work_structs.setting_structs import PerSetting, SettingHolder
...
class Setting(MyDialogSetting):
    ...
    def __init__(self, parent, setting_info, work_path):
        ...
        pic, _ = ImageWork.g_load_and_transform(os.path.join(self.path, "core\\assets\\img.jpg"),
